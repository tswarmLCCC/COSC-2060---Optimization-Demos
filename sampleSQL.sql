-- This SQL script contains the commands to create the necessary tables
-- and insert the sample data for the `get_data_from_database` function.
-- These commands are compatible with SQLite.

-- Drop tables if they already exist to ensure a clean setup
DROP TABLE IF EXISTS Professors;
DROP TABLE IF EXISTS Courses;
DROP TABLE IF EXISTS ProfessorLoad;
DROP TABLE IF EXISTS Preferences;

-- Create the tables
CREATE TABLE Professors (
    ProfessorName TEXT PRIMARY KEY
);
...
CREATE TABLE CourseDemand (
    CourseName TEXT PRIMARY KEY,
    Demand INTEGER NOT NULL
);

CREATE TABLE ProfessorLoad (
    ProfessorName TEXT PRIMARY KEY,
...
CREATE TABLE Preferences (
    ...
    PRIMARY KEY (ProfessorName, CourseName)
);
...
INSERT INTO CourseDemand (CourseName, Demand) VALUES
('Intro_to_AI', 3), ('Advanced_Algorithms', 2), ('Databases', 3), ('Operating_Systems', 2),
('Linear_Algebra', 3), ('Web_Development', 3), ('Mobile_Apps', 2), ('Machine_Learning', 3),
('Cybersecurity', 2), ('Software_Engineering', 2);

INSERT INTO ProfessorLoad (ProfessorName, Load) VALUES
('Prof_A', 5), ('Prof_B', 5), ('Prof_C', 5), ('Prof_D', 5), ('Prof_E', 5);

INSERT INTO Preferences (ProfessorName, CourseName, Preference) VALUES
